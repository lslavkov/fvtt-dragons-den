...
async function build_packs() {
  await rebuild_pack("core_dragons_den");
  return Promise.resolve();
}

async function export_packs() {
  await export_pack("core_dragons_den");
  return Promise.resolve();
}
...
export { watch }
export { serve }
export { linkUserData as link }
export { packageBuild as package }
export { updateManifest as manifest }
export { execGit as git }
